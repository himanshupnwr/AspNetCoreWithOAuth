...
namespace ImageGallery.Client.Controllers
{
    ...
    public class GalleryController : Controller
    {
        ...
        //we can find the claims we are logging in the user object which is exposed by controller base,
        //so on each controller you have access to user object which contains the claims that are the result of 
        //the complete OpenId connect flow
    }
}
